...
\makemain{
    ...
    \section{일시 및 장소}
		...
		\begin{tikzpicture}
			...
			\draw[latex-, very thick,green] (2.5,3.25) -- ++(-0.5,0) node[left,black,fill=yellow]{\small Here is the SRC629!!};
...
\noindent\makebox[\linewidth][c]{%
	\colorbox{\postertype}{%
		\parbox[c][0.14\paperheight][c]{\paperwidth}{%
			...
			\begin{minipage}[c][0.12\paperheight][c]{0.20\textwidth}
				\includegraphics[clip, trim=5.0cm 8.2cm 5.2cm 8.2cm, width=1.00\textwidth, right]{MARK-2013.pdf}
								
			\end{minipage}
			\begin{minipage}[c][0.10\paperheight][c]{0.6\textwidth}
				\textcolor{white}
				{\huge{ \textbf{The first \& the best.}}}  

			\end{minipage}
			\hfill
			\begin{minipage}[c][0.14\paperheight][c]{0.17\textwidth}
